...
const DEFAULT_FEATURES = [
  { icon:'\U0001F6E1️', title:'امنیت ۲۴ ساعته', desc:'سیستم‌های هوشمند ما بدون وقفه از اموال شما محافظت می‌کنند. هشدار فوری به موبایل در کمتر از ۳ ثانیه.', color:'#F97316', glow:'rgba(249,115,22,0.3)' },
  { icon:'\U0001F4F1', title:'کنترل از راه دور', desc:'با اپلیکیشن اختصاصی بیواز، از هر جای دنیا وضعیت امنیتی ملک خود را مشاهده و کنترل کنید.', color:'#6080FA', glow:'rgba(96,128,250,0.3)' },
  ...
  { icon:'\U0001F527', title:'پشتیبانی فنی', desc:'تیم پشتیبانی ۲۴/۷ آماده پاسخگویی است. گارانتی ۱۸ ماهه قطعات و خدمات پس از فروش.', color:'#FB923C', glow:'rgba(251,146,60,0.3)' },
  { icon:'\U0001F48E', title:'کیفیت اصل', desc:'تمام محصولات دارای گواهی اصالت و استاندارد CE اروپا هستند. فقط بهترین برای شما.', color:'#A78BFA', glow:'rgba(167,139,250,0.3)' },
  { icon:'\U0001F4B0', title:'قیمت رقابتی', desc:'بهترین کیفیت با مناسب‌ترین قیمت. امکان اقساط ۱۲ ماهه بدون بهره برای همه محصولات.', color:'#FBBF24', glow:'rgba(251,191,36,0.3)' },
]
