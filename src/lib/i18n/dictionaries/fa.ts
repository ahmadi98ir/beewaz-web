...
const fa: Dictionary = {
  common: {
    siteName: 'بیواز', loading: 'در حال بارگذاری...', error: 'خطایی رخ داد', retry: 'تلاش مجدد',
    save: 'ذخیره', cancel: 'انصراف', delete: 'حذف', edit: 'ویرایش',
    confirm: 'تأیید', search: 'جستجو', filter: 'فیلتر', all: 'همه',
    yes: 'بله', no: 'خیر', back: 'بازگشت', next: 'بعدی',
    previous: 'قبلی', submit: 'ارسال', close: 'بستن',
  },
  nav: {
  ...
  product: {
    ...
    comparePrice: 'قیمت قبل', discount: 'تخفیف', sku: 'کد محصول', category: 'دسته‌بندی',
    description: 'توضیحات', specs: 'مشخصات فنی', reviews: 'نظرات', related: 'محصولات مرتبط',
    inStock: 'موجود در انبار', freeShipping: 'ارسال رایگان',
  },
  cart: {
    title: 'سبد خرید', empty: 'سبد خرید شما خالی است', total: 'جمع کل', checkout: 'تکمیل خرید',
    continueShopping: 'ادامه خرید', quantity: 'تعداد', remove: 'حذف',
    shipping: 'هزینه ارسال', freeShipping: 'ارسال رایگان',
  },
  checkout: {
    title: 'تکمیل خرید', address: 'آدرس تحویل', payment: 'پرداخت', orderSummary: 'خلاصه سفارش',
    placeOrder: 'ثبت سفارش', province: 'استان', city: 'شهر', street: 'خیابان اصلی',
    alley: 'خیابان فرعی', plate: 'پلاک', unit: 'واحد', postalCode: 'کد پستی',
  },
  auth: {
    phone: 'شماره موبایل', otp: 'کد تأیید', sendOtp: 'ارسال کد', verifyOtp: 'تأیید کد',
    loginTitle: 'ورود به حساب کاربری', otpSent: 'کد تأیید ارسال شد',
  },
  footer: {
    rights: 'تمامی حقوق محفوظ است', privacy: 'حریم خصوصی', terms: 'شرایط استفاده',
  },
}
