    ...
    <div className="min-h-screen bg-surface-50 py-8" dir="rtl">
      <div className="max-w-2xl mx-auto px-4 space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-surface-900">ثبت و فعال‌سازی گارانتی</h1>
            <p className="text-xs text-surface-400 mt-0.5">شماره سریال محصول خود را وارد کنید</p>
          </div>
        </div>
